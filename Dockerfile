...
# Create komputerkoin user
RUN adduser --system --group --disabled-password komputerkoin && \
	mkdir -p /wallet /home/komputerkoin/.bitkomputerkoin && \
	chown -R komputerkoin:komputerkoin /home/komputerkoin/.bitkomputerkoin && \
	chown -R komputerkoin:komputerkoin /wallet

# Contains the blockchain
VOLUME /home/komputerkoin/.bitkomputerkoin

# Generate your wallet via accessing the container and run:
# cd /wallet
# komputerkoin-wallet-cli
VOLUME /wallet

EXPOSE 18080
EXPOSE 18081

# switch to user komputerkoin
USER komputerkoin

ENTRYPOINT ["komputerkoind", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=18080", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=18081", "--non-interactive", "--confirm-external-bind"]
